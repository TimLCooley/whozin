              ...
              if (isGroup(item)) {
                ...
                return (
                  <div key={item.label}>
                    ...
                    >
                      <span className={hasActiveChild ? 'text-primary' : 'text-muted'}>{item.icon}</span>
                        ...
                        {item.children.map((child) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-xl text-[13px] font-medium transition-colors
                                ${isActive
                                  ? 'bg-primary/10 text-primary'
                                  : 'text-foreground/70 hover:bg-surface active:bg-surface'
                                }`}
                            >
                              <span className={isActive ? 'text-primary' : 'text-muted'}>{child.icon}</span>
                              {child.label}
                            </button>
                          )
                        })}
