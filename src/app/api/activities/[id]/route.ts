...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (body.waitlist_visible !== undefined) updates.waitlist_visible = body.waitlist_visible !== false
  if (body.waitlist_chat_access !== undefined) updates.waitlist_chat_access = isPro && body.waitlist_chat_access === true
  ...
  if (body.tournament_format !== undefined) {
