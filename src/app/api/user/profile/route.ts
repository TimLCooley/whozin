...
export async function GET() {
  ...
  const { data: profile } = await admin
    .from('whozin_users')
    .select('id, first_name, last_name, email, phone, avatar_url, membership_tier, push_notifications_enabled, text_notifications_enabled, hide_from_invites, show_phone, show_last_name, push_token')
